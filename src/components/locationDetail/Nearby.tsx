            ...
            <>
              ...
              <div className="nearby-card">
                ...
                <div className="button-bx">
                  ...
                  <Link className="rounded-full" style={{ backgroundColor: "#00284a", color: "white", height: "36px", width: "120px", fontSize: "smaller" }} href={`/${location.data.id}`}
                    data-ya-track={`viewstore-${location.data.name}`}
                    eventName={`viewstore-${location.data.name}`}
                    rel="noopener noreferrer">
                    {/* <div dangerouslySetInnerHTML={{__html: View_Store}}/> */}
                    BRANCH DETAILS</Link>
                  <GetDirection style={{ marginLeft: "50px" }}
